...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-t&ab0v4aj=vbr%gb6b-v%te=+29^j#!zm8$h^9%a=qmp(8ijxe')
...
SPOONACULAR_API_KEY = os.environ.get('SPOONACULAR_API_KEY', 'YOUR_API_KEY_HERE')
